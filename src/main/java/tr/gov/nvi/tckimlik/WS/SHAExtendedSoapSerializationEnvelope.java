...
public class SHAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";
    public static String TAG = "easyWSDL";
    static HashMap<String, Class> classNames = new HashMap<String, Class>();
    private static SHADateTimeConverter dateTimeConverter = new SHAStandardDateTimeConverter();
    public boolean enableLogging;

    public SHAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public SHAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new SHAMarshalGuid().register(this);
        new MarshalFloat().register(this);
    }

    public static SHADateTimeConverter getDateTimeConverter() {
        return dateTimeConverter;
    }

    public static void setDateTimeConverter(SHADateTimeConverter converter) {
        if (converter == null) {
            dateTimeConverter = new SHAStandardDateTimeConverter();
        }
    ...
    public static Object getXSDType(Object param) {
        ...
        String xmlName = SHAHelper.getKeyByValue(classNames, obj);
        if (xmlName == null) {
            return obj;
        }
        return xmlName;
    ...
    protected void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null) {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector) && type.type != String.class)) {
                String xmlName = SHAHelper.getKeyByValue(classNames, obj.getClass());
                if (xmlName != null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap", Object.class, SHAExtendedSoapSerializationEnvelope.class);
