...
public class SHAKPSPublicSoap {
    ...
    public SHAKPSPublicSoap() {
    }


    public SHAKPSPublicSoap(String url) {
        this.url = url;
    }

    public SHAKPSPublicSoap(String url, int timeOut) {
        this.url = url;
    ...
    protected SHAExtendedSoapSerializationEnvelope createEnvelope() {
        SHAExtendedSoapSerializationEnvelope envelope = new SHAExtendedSoapSerializationEnvelope(SHAExtendedSoapSerializationEnvelope.VER11);
        envelope.enableLogging = enableLogging;

        return envelope;
    }

    protected List sendRequest(String methodName, SHAExtendedSoapSerializationEnvelope envelope, org.ksoap2.transport.Transport transport, com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws Exception {
    ...
    Object getResult(Class destObj, Object source, String resultName, SHAExtendedSoapSerializationEnvelope __envelope) throws Exception {
        if (source == null) {
            return null;
        }
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo, final String Ad, final String Soyad, final Integer DogumYili) throws Exception {
        ...
        return (Boolean) execute(new SHAIWcfMethod() {
            @Override
            public SHAExtendedSoapSerializationEnvelope CreateSoapEnvelope() {
                SHAExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public Object ProcessResult(SHAExtendedSoapSerializationEnvelope __envelope, Object __result) throws Exception {
    ...
    protected Object execute(SHAIWcfMethod wcfMethod, String methodName, com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws Exception {
        org.ksoap2.transport.Transport __httpTransport = createTransport();
        __httpTransport.debug = enableLogging;
        SHAExtendedSoapSerializationEnvelope __envelope = wcfMethod.CreateSoapEnvelope();
        try {
    ...
    protected Exception convertToException(org.ksoap2.SoapFault fault, SHAExtendedSoapSerializationEnvelope envelope) {
        org.ksoap2.SoapFault newException = fault;
        return newException;
    }


    interface SHAIWcfMethod {
        SHAExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws Exception;

        Object ProcessResult(SHAExtendedSoapSerializationEnvelope __envelope, Object result) throws Exception;
    }
}
